...
class Syria:
    ...
    def enter_syria_menu_check_tag(self):
        a = len(self.driver.find_elements('xpath', "/html/body/div[1]/aside/section/ul/li/a"))
        assert a == 13
        print("تعداد منو به درستی نمایش داده شد.")
        print("__________")

    def enter_syria_menu_check_name(self):
        menu_check(self, 'xpath', customer_manager_menu_name, "فرزاد اخگر")

    def enter_syria_clearance_menu_check_name(self):
        menu_check(self, 'xpath', customer_manager_menu_name, "مروة الحیجی")

    def enter_syria_menu_check_tag_dashboard(self):
    ...
    def enter_syria_clearance_menu_check_tag_dashboard(self):
        assert self.driver.find_element('xpath', "//*[@id='main-content-wrapper']/section[2]/div/div[1]")
        assert self.driver.find_element('xpath', "//*[@id='main-content-wrapper']/section[2]/div/div[2]/div[2]/div[1]/a[1]")
        assert self.driver.find_element('xpath', "//*[@id='main-content-wrapper']/section[2]/div/div[2]/div[2]/div[1]/a[2]")
        assert self.driver.find_element('xpath', "//*[@id='main-content-wrapper']/section[2]/div/div[2]/div[2]/div[2]/a[1]")
    ...
    def syria_menu_dashboard(self):
        menu_check(self, 'xpath', "/html/body/div[1]/aside/section/ul/li[2]/a", "لوحة الخیارات")

    def syria_menu_my_tasks(self):
        menu_check(self, 'xpath', "/html/body/div[1]/aside/section/ul/li[3]/a", "مهامی")

    def syria_menu_inbox(self):
        menu_check(self, 'xpath', "/html/body/div[1]/aside/section/ul/li[4]/a", "صندوق الوارد")

    def syria_menu_train(self):
        menu_check(self, 'xpath', "/html/body/div[1]/aside/section/ul/li[5]/a", "المعلومات والتدریب")

    def syria_menu_orders(self):
        menu_check(self, 'xpath', "/html/body/div[1]/aside/section/ul/li[6]/a", "الطلبات")

    def syria_menu_warehouses(self):
        menu_check(self, 'xpath', "/html/body/div[1]/aside/section/ul/li[7]/a", "المستودعات")

    def syria_menu_accept_order_op_by_scan(self):
        menu_check(self, 'xpath', "/html/body/div[1]/aside/section/ul/li[8]/a", "استلام البضائع المطلوبة عن طریق المسح")

    def syria_menu_batches(self):
        menu_check(self, 'xpath', "/html/body/div[1]/aside/section/ul/li[9]/a", "مجموعات")

    def syria_menu_crypto_gateway_recovery(self):
        menu_check(self, 'xpath', "/html/body/div[1]/aside/section/ul/li[10]/a", "تحقق من معاملة شبکة Theron")

    def syria_menu_list_excel_output(self):
        menu_check(self, 'xpath', "/html/body/div[1]/aside/section/ul/li[11]/a", "قائمة مخرج إکسل")

    def syria_menu_user_profile(self):
        menu_check(self, 'xpath', "/html/body/div[1]/aside/section/ul/li[13]/a", "بروفایل المستخدم")

    def syria_menu_change_password(self):
        menu_check(self, 'xpath', "/html/body/div[1]/aside/section/ul/li[14]/a", "تغییر کلمة المرور")

    def syria_menu_exit(self):
    ...
    def len_syria_my_task_clearance(self):
    ...
    def len_syria_clearance(self):
        a = len(self.driver.find_elements('xpath', "//*[@id='nav-category-4']/div/div/div/div[2]/a"))
        assert a == 9
        print("تعداد کارتابل های نمایشی صحیح می باشد")
        print("_____________")

    def len_syria_clearance_my_task(self):
        a = len(self.driver.find_elements('xpath', "//*[@id='main-content-wrapper']/section[2]/div[1]/div[1]/ul/li"))
        assert a == 5
        print("تعداد کارتابل های نمایشی صحیح می باشد")
        print("_____________")
    ...
    def syria_clearance_menu_batches(self):
        menu_check(self, 'xpath', "/html/body/div[1]/aside/section/ul/li[7]/a", "مجموعات")

    def syria_clearance_menu_persons(self):
        menu_check(self, 'xpath', "/html/body/div[1]/aside/section/ul/li[8]/a", "مشترين")

    def syria_clearance_menu_crypto_gateway_recovery(self):
        menu_check(self, 'xpath', "/html/body/div[1]/aside/section/ul/li[9]/a", "تحقق من معاملة شبکة Theron")

    def syria_clearance_menu_list_excel_output(self):
        menu_check(self, 'xpath', "/html/body/div[1]/aside/section/ul/li[10]/a", "قائمة مخرج إکسل")

    def syria_clearance_menu_settings(self):
        menu_check(self, 'xpath', "/html/body/div[1]/aside/section/ul/li[11]/a", "الإعدادات")
    ...
    def clearance_click_clearance(self):
        self.driver.find_element('xpath', "//*[@id='main-content-wrapper']/section[2]/div[1]/div[1]/ul/li[3]/a").click()

    def clearance_click_warehouse(self):
        self.driver.find_element('xpath', "//*[@id='main-content-wrapper']/section[2]/div[1]/div[1]/ul/li[4]/a").click()

    def clearance_click_delivery(self):
