...
class Test_Isfahan_Menu1(unittest.TestCase):
    @classmethod
    ...
    def test02_export_check_menu(self):
        ...
        menu.enter_account_isfahan_menu_check_tag()
        menu.enter_account_isfahan_menu_check_name()
        ...
        menu.enter_account_isfahan_menu_check_investigate_theron()
        menu.enter_account_isfahan_menu_check_list_excel_output()
        menu.enter_account_isfahan_menu_check_user_profile()
        menu.enter_account_isfahan_menu_check_change_password()
        menu.enter_account_isfahan_menu_check_exit()
        print("تمام موارد منوی اکانت مدیر شعبه اصفهان به درستی نمایش داده شد.")
