...
class Test_Yazd_Manager_Menu_Others(unittest.TestCase):
    @classmethod
    ...
    def test01_login(self):
        ...
        print("با موفقیت وارد پنل مدیر شعبه یزد شد")

    ################### account_yazd_check_my_tasks ###################

    def test02_account_yazd_check_my_tasks_others(self):
        ...
        tasks_list.enter_customer_manager_my_tasks_clearance_isfahan()
        ...
        tasks_list.my_tasks_check_table(7, ['ردیف', 'زمان ورود وظیفه به این کارتابل', 'سفارش', 'کالای سفارش', 'وزن سفارش (KG)', 'شماره بچ', 'تاریخ تحویل'])
        tasks_list.enter_customer_manager_my_tasks_warehouse_isfahan()
        tasks_list.transit_sea_pickup()
        tasks_list.my_tasks_check_table(8, ['ردیف', 'عملیات', ' ', 'زمان ورود وظیفه به این کارتابل', 'سفارش', 'وزن سفارش (KG)', 'خدمات موردنیاز', 'بروزرسانی'])
        ...
        tasks_list.arrived_op_in_batch_conflict()
        ...
        tasks_list.deliver_not_cleared_request()
        ...
        tasks_list.auto_wallet_refund_check_admin()
        tasks_list.my_tasks_check_table(7, ['ردیف', 'زمان ورود وظیفه به این کارتابل', 'کاربر', 'مبلغ', 'واحد', 'توضیحات', 'زمان تغییرات'])
        tasks_list.auto_new_discount()
