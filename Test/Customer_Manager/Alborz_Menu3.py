...
class Test_Alborz_Menu3(unittest.TestCase):
    @classmethod
    ...
    def test01_export(self):
        ...
        login.enter_login_username(account_alborz)
        login.enter_login_btn_submit_next()
        login.enter_login_password(code_no_admin)
        login.enter_login_btn_submit()
        print("با موفقیت وارد پنل مدیریت شعبه البرز شد. ")
        print("############################################")
    ...
    def test02_export_check_my_tasks(self):
        ...
        tasks_list.solve_defection_transport_invoice_isfahan()
        ...
        tasks_list.complete_user_info_to_register_in_arian_isfahan()
        tasks_list.my_tasks_check_table(11,
                                        ['ردیف', 'عملیات', ' ', 'زمان ورود وظیفه به این کارتابل', 'نام و نام خانوادگی',
                                         'کدملی', 'موبایل1', 'موبایل2', 'تلفن ثابت 1', 'وضعیت', 'توضیحات عدم تایید'])
        tasks_list.enter_clearance_information_isfahan()
        sleep(2)
        ...
        tasks_list.my_tasks_check_table(11, ['ردیف', 'عملیات', ' ', 'زمان ورود وظیفه به این کارتابل', 'سفارش', 'کالای سفارش', 'وزن سفارش (KG)', 'شماره بچ',  'شماره ترک فرعی', 'ثبت اطلاعات تحویل قبض', 'تحویل قبض'])
