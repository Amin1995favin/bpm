...
class Test_Manager_Menu_Others(unittest.TestCase):
    @classmethod
    ...
    def test02_customer_manager_check_my_tasks_others(self):
        ...
        tasks_list.need_final_clearance_urgency_in_auto_billed_order()
