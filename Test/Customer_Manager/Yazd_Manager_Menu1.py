...
class Test_Yazd_Manager_Menu1(unittest.TestCase):
    @classmethod
    ...
    def test02_customer_manager_check_menu(self):
        ...
        menu.enter_yazd_manager_menu_check_tag()
        menu.enter_customer_manager_menu_check_tag_dashboard()
        menu.enter_account_yazd_manager_menu_check_name()
        ...
        menu.enter_customer_manager_menu_check_phone_marketer_calls()
        menu.enter_yazd_manager_menu_check_list_excel_output()
        menu.enter_yazd_manager_menu_check_user_profile()
        menu.enter_yazd_manager_menu_check_change_password()
        menu.enter_yazd_manager_menu_check_exit()
        print("تمام موارد منوی مدیر مشتری یزد به درستی نمایش داده شد.")
