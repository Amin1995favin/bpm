...
class Test_Isfahan_Menu4(unittest.TestCase):
    @classmethod
    ...
    def test02_export_check_my_tasks(self):
        ...
        tasks_list.information_shipping_orders_by_partner_company_isfahan()
        ...
        tasks_list.review_buy_requests_isfahan()
        ...
        tasks_list.notify_of_buy_isfahan()
        tasks_list.my_tasks_check_table(13, ['ردیف', 'عملیات', ' ', 'زمان ورود وظیفه به این کارتابل', 'تاییدیه درخواست های خرید', 'سفارش', 'مبدا', 'مقصد', 'خدمت', 'لیست کالاها', 'اطلاعات درخواست خرید', 'عملیات', 'ایجادکننده'])
        tasks_list.awaiting_settlement_isfahan()
        tasks_list.my_tasks_check_table(6, ['ردیف', 'زمان ورود وظیفه به این کارتابل', 'سفارش', 'بروزرسانی', 'وزن سفارش (KG)', 'خدمات موردنیاز'])
        tasks_list.auto_orders_transport_batches_isfahan()
