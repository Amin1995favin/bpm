...
class Test_Customer_Manager_Menu3(unittest.TestCase):
    @classmethod
    ...
    def test02_customer_manager_check_my_tasks(self):
        ...
        tasks_list.my_tasks_check_table(15, ['ردیف', 'عملیات', 'سفارش', 'زمان ورود وظیفه به این کارتابل', 'شخص ارسال کننده', 'شرکت ارسال کننده', 'تلفن تماس شخص فرستنده', 'تاریخ و زمان آمادگی فرستنده جهت پیک آپ', 'توضیحات تاریخ و زمان آمادگی فرستنده', 'شماره ترک سفارش در شرکت حمل کننده', 'نام شرکت حمل کننده', 'فایل پیوست', 'لیبل 1', 'لیبل 2', 'خروج از کارتابل'])
        sleep(1)
        # tasks_list.auto_chat_by_customer()
        # tasks_list.my_tasks_check_table(10,['ردیف', 'عملیات', ' ', 'زمان ورود وظیفه به این کارتابل', 'نام و نام خانوادگی', 'مدیر مشتری', 'تاریخ عضویت', 'تاریخ آخرین سفارش انجام شده', 'تعداد سفارشات', 'کارکرد مالی'])
