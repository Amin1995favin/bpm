...
class Test_Financial_Menu1(unittest.TestCase):
    @classmethod
    ...
    def test03_financial_check_my_tasks(self):
        my_tasks = My_Tasks(driver=self.driver)
        financial = Financial_My_Tasks(driver=self.driver)
        ...
        my_tasks.my_tasks_check_table(6, ['ردیف', 'سفارش', 'زمان ورود وظیفه به این کارتابل', 'سفارش', 'مشخصات وزن (KG)', 'خدمات موردنیاز'])
