...
class Test_Admin_Menu15(unittest.TestCase):
    @classmethod
    ...
    def test02_admin_customer_manager_check_my_tasks(self):
        ...
        admin.my_tasks_check("//*[@id='task-collapse-7']/div[2]/div/div/div[2]/a[1]")
        ...
        admin.my_tasks_check("//*[@id='task-collapse-7']/div[2]/div/div/div[2]/a[2]")
        ...
        admin.my_tasks_check("//*[@id='task-collapse-7']/div[2]/div/div/div[2]/a[3]")
        my_tasks.my_tasks_check_table(9, ['ردیف', 'عملیات', ' ', 'زمان ورود وظیفه به این کارتابل', 'کاربر', 'مبلغ', 'واحد', 'توضیحات', 'زمان تغییرات'])
        admin.my_tasks_check("//*[@id='task-collapse-7']/div[2]/div/div/div[2]/a[4]")
        my_tasks.my_tasks_check_table(8, ['ردیف', 'عملیات', 'مبلغ', 'زمان ورود وظیفه به این کارتابل', 'وضعیت',  'حساب', 'زمان پرداخت', 'خروج از کارتابل'])
        sleep(1)
        admin.my_tasks_check("//*[@id='task-collapse-7']/div[2]/div/div/div[2]/a[5]")
        my_tasks.my_tasks_check_table(9, ['ردیف', 'زمان ورود وظیفه به این کارتابل', 'سفارش', 'تاریخ تحویل',  'نام تحویل گیرنده', 'شماره تماس تحویل گیرنده', 'آدرس محل تحویل', 'نحوه ی پرداخت مالی سفارش جهت تحویل', 'توضیحات دلیوری'])
        admin.my_tasks_check("//*[@id='task-collapse-7']/div[2]/div/div/div[2]/a[6]")
        ...
        admin.my_tasks_check("//*[@id='task-collapse-7']/div[2]/div/div/div[2]/a[7]")
        ...
        admin.my_tasks_check("//*[@id='task-collapse-7']/div[2]/div/div/div[2]/a[8]")
        my_tasks.my_tasks_check_table(7, ['ردیف', 'عملیات', ' ', 'زمان ورود وظیفه به این کارتابل', 'وضعیت', 'مبلغ', 'پیش اختصاص به فاکتور ها'])
        admin.my_tasks_check("//*[@id='task-collapse-7']/div[2]/div/div/div[2]/a[9]")
        ...
        admin.my_tasks_check("//*[@id='task-collapse-7']/div[2]/div/div/div[2]/a[10]")
        my_tasks.my_tasks_check_table(5, ['ردیف', 'عملیات', ' ', 'زمان ورود وظیفه به این کارتابل',  'سفارش'])
        admin.my_tasks_check("//*[@id='task-collapse-7']/div[2]/div/div/div[2]/a[11]")
        ...
        admin.my_tasks_check("//*[@id='task-collapse-7']/div[2]/div/div/div[2]/a[12]")
        ...
        admin.my_tasks_check("//*[@id='task-collapse-7']/div[2]/div/div/div[2]/a[13]")
        ...
        admin.my_tasks_check("//*[@id='task-collapse-7']/div[2]/div/div/div[2]/a[14]")
