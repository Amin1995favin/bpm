...
class Test_Admin_Menu5(unittest.TestCase):
    @classmethod
    ...
    def test02_admin_check_my_tasks(self):
        ...
        admin.my_tasks_check("//*[@id='task-collapse-5']/div[2]/div/div/div[2]/a[1]")
        ...
        admin.my_tasks_check("//*[@id='task-collapse-5']/div[2]/div/div/div[2]/a[2]")
        ...
        admin.my_tasks_check("//*[@id='task-collapse-5']/div[2]/div/div/div[2]/a[3]")
        ...
        admin.my_tasks_check("//*[@id='task-collapse-5']/div[2]/div/div/div[2]/a[4]")
        ...
        admin.my_tasks_check("//*[@id='task-collapse-5']/div[2]/div/div/div[2]/a[5]")
        my_tasks.my_tasks_check_table(9, ['ردیف', 'عملیات', ' ', 'زمان ورود وظیفه به این کارتابل', 'کاربر', 'مبلغ', 'واحد', 'توضیحات', 'زمان تغییرات'])
        admin.my_tasks_check("//*[@id='task-collapse-5']/div[2]/div/div/div[2]/a[6]")
        ...
        admin.my_tasks_check("//*[@id='task-collapse-5']/div[2]/div/div/div[2]/a[10]")
        ...
        admin.my_tasks_check("//*[@id='task-collapse-5']/div[2]/div/div/div[2]/a[11]")
        my_tasks.my_tasks_check_table(6, ['ردیف', 'زمان ورود وظیفه به این کارتابل', 'سفارش', 'بروزرسانی', 'وزن سفارش (KG)', 'خدمات موردنیاز'])
        admin.my_tasks_check("//*[@id='task-collapse-5']/div[2]/div/div/div[2]/a[12]")
        ...
        admin.my_tasks_check("//*[@id='task-collapse-5']/div[2]/div/div/div[2]/a[13]")
