...
class Test_Admin_Menu6(unittest.TestCase):
    @classmethod
    ...
    def test02_admin_customer_manager_check_my_tasks(self):
        ...
        admin.my_tasks_check("//*[@id='task-collapse-4']/div[1]/div/div/div[2]/a[1]")
        my_tasks.my_tasks_check_table(7, ['ردیف', 'عملیات', ' ', 'زمان ورود وظیفه به این کارتابل', 'سفارش', 'وزن سفارش (KG)', 'خدمات موردنیاز'])
        admin.my_tasks_check("//*[@id='task-collapse-4']/div[1]/div/div/div[2]/a[2]")
        ...
        admin.my_tasks_check("//*[@id='task-collapse-4']/div[1]/div/div/div[2]/a[3]")
        ...
        admin.my_tasks_check("//*[@id='task-collapse-4']/div[1]/div/div/div[2]/a[4]")
        ...
        admin.my_tasks_check("//*[@id='task-collapse-4']/div[1]/div/div/div[2]/a[5]")
        my_tasks.my_tasks_check_table(8, ['ردیف', 'عملیات', ' ', 'زمان ورود وظیفه به این کارتابل', 'سفارش', 'کالای سفارش', 'وزن سفارش (KG)', 'نوع حمل'])
        admin.my_tasks_check("//*[@id='task-collapse-4']/div[1]/div/div/div[2]/a[6]")
        my_tasks.my_tasks_check_table(11, ['ردیف', 'عملیات', ' ', 'زمان ورود وظیفه به این کارتابل', 'سفارش', 'کالای سفارش', 'شخص دریافت کننده', 'شخص ارسال کننده', 'نوع حمل', 'وزن سفارش (KG)', 'نوع پیش فاکتور حمل'])
        admin.my_tasks_check("//*[@id='task-collapse-4']/div[1]/div/div/div[2]/a[7]")
        ...
        admin.my_tasks_check("//*[@id='task-collapse-4']/div[1]/div/div/div[2]/a[8]")
        sleep(1)
        ...
        admin.my_tasks_check("//*[@id='task-collapse-4']/div[1]/div/div/div[2]/a[9]")
        sleep(1)
        ...
        admin.my_tasks_check("//*[@id='task-collapse-4']/div[1]/div/div/div[2]/a[10]")
