...
class Test_New_Persons(unittest.TestCase):
    @classmethod
...
################### Login_customer_manager ###################
    ...
    def test01_login_customer_manager(self):
        ...
        message = "با موفقیت با پسورد جدید وارد شد. و تست به درستی به پایان رسید."
...
Mongodb.run_tests_and_insert_into_mongodb(Test_New_Persons , 'new_persons')
