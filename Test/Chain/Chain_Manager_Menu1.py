...
class Test_Chain_Manager_Menu1(unittest.TestCase):
    @classmethod
    ...
    def test01_chain_manager(self):
        self.driver.get("http://testbpm.2ms.ir/login")
        login = LoginPage(driver=self.driver)
        login.enter_login_username(chain_manager)
        login.enter_login_btn_submit_next()
        login.enter_login_password(code_no_admin)
        login.enter_login_btn_submit()
        print("با موفقیت وارد پنل مدیریت اکانت مدیر مشتری چین شد. ")
        print("############################################")

    ################### chain_manager_check_menu ###################
    ...
    def test02_chain_check_menu(self):
        ...
        chain.enter_chain_manager_menu_check_name()
    ...
    ################### chain_manager_check_my_tasks ###################

    def test03_chain_manager_check_my_tasks(self):
