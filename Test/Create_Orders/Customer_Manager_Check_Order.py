...
class Test_Customer_Manager_Check_Order(unittest.TestCase):
    @classmethod
    ...
    def test05_orders_create_products(self):
        ...
        orders_create.enter_customer_manager_check_box_transporter_inquery2()
...
Mongodb.run_tests_and_insert_into_mongodb(Test_Customer_Manager_Check_Order, 'Customer_Manager_Check_Order')
