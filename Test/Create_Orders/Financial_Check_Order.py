...
class Test_Financial_Check_Order(unittest.TestCase):
    @classmethod
    ...
    def test06_orders_create_products(self):
        ...
        orders_create.enter_product_click_checking_the_order()
        orders_create.enter_financial_manager_checking_the_order()
        ...
        orders_create.enter_financial_manager_check_box_order_obligation()
        ...
        my_tasks.enter_clearance_my_tasks_need_to_issue4()
        orders_create.enter_financial_check_box_clearance_inquery()
        ...
        orders_create.enter_financial_manager_check_box_invoices()
        self.driver.back()
        # self.driver.back()
        ...
        orders_create.enter_financial_manager_check_box_op()
        ...
        orders_create.enter_financial_manager_check_box_logs()
        self.driver.back()
        ...
        sleep(3)
        orders_create.enter_financial_manager_check_box_arian()
