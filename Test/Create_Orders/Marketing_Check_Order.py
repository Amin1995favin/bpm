...
class Test_Marketing_Check_Order(unittest.TestCase):
    @classmethod
    ...
    def test05_login_admin(self):
        ...
        orders_create = Orders_Create(driver=self.driver)
        login.enter_login_username(account_marketing)
        login.enter_login_btn_submit_next()
        login.enter_login_password(code_no_admin)
        login.enter_login_btn_submit()
        print("با موفقیت وارد پنل کارشناس بازاریاب شد")
        print("############################################")
    ...
    def test06_orders_create_products(self):
        ...
        orders_create.enter_check_delivery_manager_orders_doing_open()
        orders_create.enter_product_click_checking_the_order()
        orders_create.enter_marketing_manager_checking_the_order()
        self.driver.back()
        orders_create.enter_click_checking_the_order()
        orders_create.enter_account_marketing_check_box_chat()
        self.driver.back()
        ...
        orders_create.enter_delivery_manager_check_box_payment()
        ...
        orders_create.check_table("//*[@id='paymentList']/div[6]/div/div//table/thead/tr", 6, ['ردیف', 'کاربر مرتبط', 'نوع تراکنش', 'مبلغ تراکنش', 'تراکنش به ریال', 'ایجادکننده'])
        orders_create.check_table("//*[@id='payment_tn']/div//table/thead/tr", 9, ['ردیف', 'وضعیت', 'مبلغ', 'پیش اختصاص به فاکتور ها', 'حساب', 'شماره پیگیری پرداخت', 'توضیحات', 'توضیحات تایید / عدم تایید', 'ایجادکننده'])
        self.driver.back()
        orders_create.enter_admin_click_order_loaded_goods()
        orders_create.enter_delivery_manager_check_order_loaded_goods()
        self.driver.back()
        ...
        orders_create.enter_delivery_manager_check_box_logs()
        self.driver.back()
