...
class Test_Financial_Manager_Check_Order(unittest.TestCase):
    @classmethod
    ...
    def test06_orders_create_products(self):
        ...
        orders_create.check_table("//*[@id='main-content-wrapper']/section[2]/div[3]/div//table/thead/tr", 10, ['ردیف', 'شماره پیش فاکتور', 'عنوان', 'قیمت اعلامی', 'قیمت نهایی (با نرخ تبدیل خام)', 'قیمت نهایی', 'تسعیر ارز', 'پرداخت شده (در واحد)', 'عملیات', 'کاربر ایجاد کننده'])
