...
class Test_Admin_Check_Order(unittest.TestCase):
    @classmethod
    ...
    # def test06_check_orders(self):
        ...
        orders_create.enter_click_orders_check_len()
        print("############################################")
    ...
    def test06_orders_create_products(self):
        ...
        orders_create.enter_check_admin_orders_doing_open()
        orders_create.enter_product_click_checking_the_order()
        orders_create.enter_checking_the_order()
        ...
        orders_create.check_table("//*[@id='oplist2']//table/thead/tr", 24, ['ردیف', 'شناسه', 'دسته بندی کلی کالا', 'دسته بندی جزئی کالا', 'نام کالا', 'واحد تعداد', 'تعداد', 'وزن واحد(kg)', 'جمع وزن جرمی(kg)', 'کل وزن قابل پرداخت', 'طول واحد(cm)', 'cbm کل', 'جمع وزن حجمی', 'تعداد کالا در هر جعبه', 'ارزش واحد کالای در جعبه', 'ارزش کل کالا(ها)', 'HSCODE', 'پارت نامبر', 'لینک خرید', 'تصویر', 'فایل Proforma Invoice', 'فایل Packing List', 'سایر فایل های پیوست', 'توضیحات'])
        ...
        orders_create.check_table("//*[@id='main-content-wrapper']/section[2]/div/div[6]/div/div//table/thead/tr", 6, ['ردیف', 'نام کالا', 'تصویر', 'فایل Proforma Invoice', 'فایل Packing List', 'سایر فایل های پیوست'])
        orders_create.check_table("//*[@id='main-content-wrapper']/section[2]/div/div[7]/div//table/thead/tr", 5, ['ردیف', 'عنوان', 'متن', 'فایل پیوست', 'ایجادکننده'])
        self.driver.back()
        ...
        orders_create.enter_check_box_order_obligation()
        ...
        (orders_create.
         enter_check_box_transporter_inquery())
        orders_create.check_table("//*[@id='main-content-wrapper']/section[2]/div[1]/div//table/thead/tr", 17, ['ردیف', 'معتبر است؟', 'نحوه ارسال', 'همکار', 'نوع استعلام', 'وزن قابل پرداخت', 'قیمت مصوب', 'قیمت', 'قیمت هر کیلو', 'واحد', 'فاکتور رسمی؟', 'قیمت نهایی', 'زمان ارسال', 'توضیحات', 'زمان ایجاد', 'ایجادکننده', 'صادر شده بعد از بارگیری'])
        ...
        orders_create.check_table("//*[@id='main-content-wrapper']/section[2]/div[3]/div//table/thead/tr", 11, ['ردیف', 'شماره پیش فاکتور', 'عنوان', 'قیمت اعلامی', 'هزینه به دلار', 'قیمت نهایی (با نرخ تبدیل خام)', 'قیمت نهایی', 'تسعیر ارز', 'پرداخت شده (در واحد)', 'عملیات', 'کاربر ایجاد کننده'])
        ...
        scrolled1 = self.driver.find_element('xpath', "//table/tbody/tr[1]/td[10]/div[2]/a[1]")
        sleep(1)
        scrolled1.location_once_scrolled_into_view
        tasks_list.enter_customer_manager_my_tasks_send_invoice_not_sent_to_the_customer2()
        print("فاکتور حمل به مشتری ارسال شد. ")
        self.driver.refresh()
        sleep(1)
        scrolled2 = self.driver.find_element('xpath', "//table/tbody/tr[1]/td[10]/div[3]/a[1]")
        sleep(1)
        scrolled2.location_once_scrolled_into_view
        tasks_list.enter_customer_manager_my_tasks_conformation_by_customer_approval2()
        print("فاکتور حمل توسط مشتری تایید شد. ")
        orders_create.enter_check_box_invoices()
        self.driver.back()
        # self.driver.back()
        orders_create.enter_admin_click_box_payment()
        orders_create.enter_check_box_payment()
        orders_create.check_table("//*[@id='paymentList']/div[1]//table/thead/tr", 10, ['ردیف', 'شماره پیش فاکتور', 'عنوان', 'قیمت اعلامی', 'هزینه به دلار', 'قیمت نهایی (با نرخ تبدیل خام)', 'قیمت نهایی', 'تسعیر ارز', 'پرداخت شده (در واحد)', 'کاربر ایجاد کننده'])
        self.driver.back()
        ...
        orders_create.enter_check_box_op()
        ...
        orders_create.enter_check_box_logs()
        self.driver.back()
        ...
        orders_create.enter_check_box_financial()
        orders_create.check_table("//*[@id='main-content-wrapper']/section[2]/div[1]//table/tbody/tr", 4, ['ردیف', 'عنوان', 'وضعیت', 'سایر اطلاعات'])
        orders_create.check_table("//*[@id='main-content-wrapper']/section[2]/div[3]/div/div[2]/div[1]/div[2]/div/div//table/thead/tr", 4, ['ردیف', 'نوع خدمت', 'هزینه', 'پرداخت اصلاح سابقه'])
        orders_create.check_table("//*[@id='main-content-wrapper']/section[2]/div[3]/div/div[2]/div[2]/div[2]/div/div//table/thead/tr", 3, ['ردیف', 'نوع خدمت', 'فاکتور بدون مالیات'])
        orders_create.check_table("//*[@id='main-content-wrapper']/section[2]/div[3]/div/div[2]/div[3]/div[2]/div/div//table/thead/tr", 3, ['ردیف', 'نوع خدمت', 'درآمد بدون مالیات'])
        self.driver.back()
        orders_create.enter_admin_click_box_track_order()
...
Mongodb.run_tests_and_insert_into_mongodb(Test_Admin_Check_Order , 'Admin_Check_Order')
