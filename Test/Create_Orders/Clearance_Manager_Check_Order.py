...
class Test_Clearance_Manager_Check_Order(unittest.TestCase):
    @classmethod
...
Mongodb.run_tests_and_insert_into_mongodb(Test_Clearance_Manager_Check_Order, 'Clearance_Manager_Check_Order')
