...
class Test_Delivery_Check_Order(unittest.TestCase):
    @classmethod
    ...
    ################### Login_account_delivery ###################

    def test05_login_account_delivery(self):
    ...
    def test06_orders_create_products(self):
        ...
        orders_create.enter_product_click_checking_the_order()
        orders_create.enter_delivery_manager_checking_the_order()
        self.driver.back()
        orders_create.enter_click_checking_the_order()
        orders_create.enter_delivery_manager_check_box_chat()
        self.driver.back()
