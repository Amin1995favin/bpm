...
class Test_Create_Order(unittest.TestCase):
    @classmethod
    ...
    def test01_login_customer_manager(self):
        ...
        wait_until_element_has_an_attribute_and_send_keys(self, 'xpath', login_username, "989020981024")
    ...
    def test06_orders_create_products(self):
        ...
        orders_create.enter_check_box_transporter_inquery()
